...
void stu_reg()
{
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        if (stud[i].grade > 8 && stud[i].grade < 11)
        {
            int c;
            cout << string(75, '-') << endl;
            cout << "student " << stud[i].name << " monthly  wage would be " << hlm << endl;
            cout << "How do you want to complete the payment " << endl;
            cout << "1) monthly" << endl << "2) By term" << endl << "3) Yearly" << endl;
            cin >> c;
        ...
        if (stud[i].grade > 10 && stud[i].grade < 13)
        {
            int v;
            cout << string(75, '-') << endl;
            cout << "student " << stud[i].name << " monthly  wage would be " << prm << endl;
            cout << "How do you want to complete the payment " << endl;
            cout << "1) monthly" << endl << "2) By term" << endl << "3) Yearly" << endl;
            cin >> v;
...
// prints payement info
void payment_info()
{
    // prints line and payement info 
    cout << string(75, '-') << endl;
